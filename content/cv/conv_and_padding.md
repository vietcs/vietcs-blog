...
* Một toán tử (hệ thống) $H$ được gọi là tuyến tính (*linearity*) nếu thỏa mãn cả hai tính chất sau:
...
* Trong bài (Nhập môn Filtering) có nhắc đến khái niệm *filter tuyến tính*, qua các tính chất ở trên, ta có thể định nghĩa: ***"Một filter tuyến tính là một filter mà giá trị các output pixel có quan hệ tuyến tính với các pixel lân cận của nó."***

### **2. Cross-correlation và convoution**
...
* *Convolution* là toán tử mà ta xoay kernel 180 độ *(flip over)* rồi áp dụng phép *correlation*. 
  ...
  <p>
      ...
      <center><caption><i>Cross-correlation & Convolution</i></caption></center>
  </p>
...
* Sự khác biệt duy nhất mà chúng ta thấy được qua công thức trên là: *convolution* lật ngược kernel rồi mới thực hiện sliding window. Tuy nhiên chính điều này đã tạo nên tính chất riêng của *convolution* mà *cross-correlation* không có:
  ...
  * Chính **tính phân phối** này giúp ta có thể tối ưu hóa độ phức tạp của phép *convolution* trong lập trình.
...
* Khi bạn dùng bộ lọc $W\times W$ cho một ảnh có kích thước $N\times N$, ảnh đầu ra sẽ có kích thước $(N-W+1)\times (N-W+1)$.
  ...
  <p>
      ...
      <center><caption><i>Tittle</i></caption></center>
  </p>
...
* Khó mà giải thích bằng lời về **wrap padding**, bạn có thể hiểu qua các ví dụ sau:
  ...
  <p>
      <img src = 'https://raw.githubusercontent.com/khoaxxx238/DOC/master/img/padding.png' width=500>
      <center><caption><i>Padding</i></caption></center>
...
[4] [Cross-correlation](https://en.wikipedia.org/wiki/Cross-correlation)
...
[7] [Cross-correlation vs Convolution](https://glassboxmedicine.com/2019/07/26/convolution-vs-cross-correlation/)

[8] [Making border in OpenCV](https://www.sharebook.site/2017/08/13/opencv-basic-images-operations)

[9] [Why use symmetric padding?](https://www.quora.com/Why-do-we-need-symmetric-padding-method-to-calculate-the-boundary-value-while-we-are-extracting-feature-in-case-of-2D-medical-image)

[10] [Why use reflect padding?](https://www.reddit.com/r/learnmachinelearning/comments/8hetaz/can_someone_explain_to_me_what_reflection_padding/)

[11] [Biến đổi tuyến tính | Wiki]([https://vi.wikipedia.org/wiki/Bi%E1%BA%BFn_%C4%91%E1%BB%95i_tuy%E1%BA%BFn_t%C3%ADnh](https://vi.wikipedia.org/wiki/Biến_đổi_tuyến_tính))
